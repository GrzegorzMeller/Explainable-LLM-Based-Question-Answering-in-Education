...
<p>This README serves as the primary entry point and contains descriptions of the interface components, their intended purpose, and their role within the study. High-resolution screenshots of the system can be found in the <a href="screens/main.png">Screens Folder</a>. To support transparency and reproducibility of the qualitative analysis, the repository also includes the complete thematic analysis <a href="Codebook.md">Codebook</a> used for coding participant transcripts, including code definitions and examples.</p>
...
<p>Stimulus 2</p>
<img width="100%" height="63.08%" alt="condition2" src="https://github.com/user-attachments/assets/d6c236d5-7cb0-4b86-bb35-c8ffcdb6d84e" />

<p>Stimulus 3</p>
<img width="100%" height="63.08%" alt="condition3" src="https://github.com/user-attachments/assets/73635bad-5d1d-476d-9bac-2492c7bc0c8a" />
<br />

<h2>Learning Analytics Integration</h2>
<img width="100%" height="64.85%" alt="learninganlytics" src="https://github.com/user-attachments/assets/22a8de40-9367-4413-8b23-3776282e8a60" />
...
<img width="100%" height="147.08%" alt="faithfulness_table_expanded" src="https://github.com/user-attachments/assets/c85526f5-b377-4469-8343-53b9f1802fd2" />
...
<h2>Design Concept: Inline Highlight Explanations (Illustrative Redesign Based on Participant Feedback)</h2>
<img width="100%" height="64.85%" alt="inline_highlights" src="https://github.com/user-attachments/assets/e0af9f5f-a1f5-418b-b7f4-93df44fdbc48" />
<p>Participants in the user study reported that locating unsupported statements in the Faithfulness Table required substantial effort and suggested highlighting unsupported content directly within the generated answer. This screen illustrates one possible implementation of that design implication. Unsupported statements are highlighted directly in the generated answer and linked to an explanation describing why the claim is not grounded in the extracted learning materials. The concept is intended as a design hypothesis derived from participant feedback and has not been empirically evaluated.</p>
<br />

<h2>Early design used during the co-design session</h2>
<img width="100%" height="93.25%" alt="File Upload (3)" src="https://github.com/user-attachments/assets/b2e1721b-70f5-4ac9-8e89-074075113e01" />
